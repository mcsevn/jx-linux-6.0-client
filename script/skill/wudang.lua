...
SKILLS={
	...
	tiandi_wuji={ --Thien Dia Vo Cuc 365
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}}, -- ngu hanh tuong khac
		skill_cost_v={{{1,60},{20,150}}}, -- dong 2 tieu hao noi luc
		skill_attackradius={{{1,448},{20,512},{20,512}}}, -- dong 3 pham vi hieu qua
		lightingdamage_v={ -- dong 4 Loi sat noi cong
			[1]={{1,5},{15,100},{20,200}}, 
			[3]={{1,5},{15,150},{20,350}}
		},
		stun_p={{{1,10},{20,20},{25,30},{26,30}},{{1,1},{20,6},{21,6}}}, -- dong 5 lam choang
